...
let load_scene p file r h =
  ...
  try
    ...
    do
      ...
      if line.(0) = "c"
      then
	characters := (Objet.create (int_of_string line.(2)) (int_of_string line.(3)) textures.(int_of_string line.(1)) 10. 1 (int_of_string line.(4)) (int_of_string line.(5)) 0 100000000 false true true 3 [])::!characters
      else
	objects := (Objet.create (int_of_string line.(2)) ((int_of_string line.(3))) textures.(int_of_string line.(1)) 0. 1 (int_of_string line.(4)) (int_of_string line.(5)) 0 100000000 false (bool_of_string line.(6)) false 0 [])::!objects
